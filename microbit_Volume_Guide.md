...
Notice we are using a different scale for this volume project. Therefore, we need to chang CLICK_MAX and clickCt to 5 because we only have 5 rows of LEDS for our visual display. 
